...
function findDup(array) {
    let elementCounts = {}; // key -> elem and value -> count of the elem in arr

    for(const elem of array) {
        // check if elem exists in elementCounts
        if (!Object.prototype.hasOwnProperty.call(elementCounts, elem)) {
